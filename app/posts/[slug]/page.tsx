        ...
        <div className="relative">
          <div className="absolute -left-24">
            <a href="/#writing" className="hidden lg:block fixed group">
              <div className="ml-2 group-hover:-translate-x-2 ease-in-out duration-200 group sm:group-hover:text-[#af8d19]">
                <svg
              ...
              <div className="opacity-0 group-hover:opacity-100 group-hover:block text-[12px] text-slate-200 group duration-200 sm:group-hover:text-[#af8d19]">
                BACK
              </div>
            </a>
          </div>
...
export async function generateMetadata({
  ...
  const post = getPostContent(slug);
  return {
    title: `${post.data.title} | Steven Mugisha`,
